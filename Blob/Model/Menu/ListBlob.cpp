...
ListBlob::ListBlob()
{
    ...
    this->listeBlob.emplace_back(new Blob("Maskass",120, new Feu()));
    this->listeBlob.emplace_back(new Blob("Carlos", 70, new Eau()));
    this->listeBlob.emplace_back(new Blob("Jordy", 80, new Eau()));
    this->listeBlob.emplace_back(new Blob("Juan", 79, new Plante()));
